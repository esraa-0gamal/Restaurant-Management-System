    ...
    public partial class InitialRestaurantDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishExtra", x => new { x.DishesDishId, x.ExtrasExtraId });
                    table.ForeignKey(
                        name: "FK_DishExtra_Dishes_DishesDishId",
                        column: x => x.DishesDishId,
                        principalTable: "Dishes",
                        principalColumn: "DishId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishExtra_Extras_ExtrasExtraId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderItemExtraId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderItemId = table.Column<int>(type: "int", nullable: false),
                    ExtraId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemExtras", x => x.OrderItemExtraId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishExtra_ExtrasExtraId",
                table: "DishExtra",
                column: "ExtrasExtraId");
